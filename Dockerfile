...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name tickets_system_v2 tickets_system_v2
...
# Install JavaScript dependencies for jsbundling/esbuild.
